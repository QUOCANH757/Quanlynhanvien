...
<body>
    <div class="login-container">
        ...
        <div class="login-footer">
            <div>Chưa có tài khoản? <a href="index.php?action=register">Đăng ký ngay</a></div>
            <div style="margin-top: 8px;"><a href="index.php?action=forgot-password">🔑 Quên mật khẩu?</a></div>
        </div>
    </div>
</body>
</html>